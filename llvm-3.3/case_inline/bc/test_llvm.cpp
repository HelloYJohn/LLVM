...
int main(int argc, char**argv) {
	...
	mod = new Module("main_module" , getGlobalContext());
    SMDiagnostic error;
	Module* link_mod = ParseIRFile("static_library.bc", error, getGlobalContext());

	std::string link_error_code = "";	
	Linker::LinkModules(mod, link_mod, 1 , &link_error_code) ;
...
void makeLLVMModule() {
    ...
    // Function: _Z4callii (func__Z4callii)
    {
        ...
        CallInst* int32_call = CallInst::Create(func__Z4testii, int32_call_params, "test", label_entry);
